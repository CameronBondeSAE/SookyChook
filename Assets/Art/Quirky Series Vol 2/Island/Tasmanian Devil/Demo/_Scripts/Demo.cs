...
public class Demo : MonoBehaviour {
	...
	void Update () {
		...
		if (InputSystem.GetDevice<Keyboard>().rightArrowKey.wasPressedThisFrame) { NextAnim (); }
		else if (InputSystem.GetDevice<Keyboard>().leftArrowKey.wasPressedThisFrame) { PrevAnim (); }
	}
